const PrivacyPolicy = () => {
  return (
    <div className="text-text bg-gray-800">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6">Datenschutzerklärung</h1>
        <p className="mb-4">
          Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen.
          Datenschutz hat einen besonders hohen Stellenwert für die
          Geschäftsleitung der Charalambos Makridakis. Eine Nutzung der
          Internetseiten der Charalambos Makridakis ist grundsätzlich ohne jede
        ...
        <p className="mb-4">
          ...
          und in Übereinstimmung mit den für die Charalambos Makridakis
        ...
        <p className="mb-4">
          Die Charalambos Makridakis hat als für die Verarbeitung
        ...
        <p className="mb-4">
          Die Datenschutzerklärung der Charalambos Makridakis beruht auf den
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>
            <h3 className="text-lg font-medium inline">
          ...
          <li>
            <h3 className="text-lg font-medium inline">b) betroffene Person</h3>
            <p>
          ...
          <li>
            <h3 className="text-lg font-medium inline">c) Verarbeitung</h3>
            <p>
          ...
          <li>
            <h3 className="text-lg font-medium inline">e) Profiling</h3>
            <p>
          ...
          <li>
            <h3 className="text-lg font-medium inline">f) Pseudonymisierung</h3>
            <p>
          ...
          <li>
            <h3 className="text-lg font-medium inline">i) Empfänger</h3>
            <p>
          ...
          <li>
            <h3 className="text-lg font-medium inline">j) Dritter</h3>
            <p>
          ...
          <li>
            <h3 className="text-lg font-medium inline">k) Einwilligung</h3>
            <p>
        ...
        <address className="not-italic mb-4">
          <strong>Charalambos Makridakis</strong>
          <br />
          Schmiedegasse 2<br />
          ...
          <br />
          Tel.:{" "}
          <p className="text-blue-200 hover:underline">+49 1577 1014985</p>
          E-Mail:{" "}
          <p className="text-blue-200 hover:underline">c.makridakis@gmx.de</p>
          Website:{" "}
          <p className="text-blue-200 hover:underline">www.makridakis.tech</p>
        </address>
        ...
        <p className="mb-4">
          Die Internetseite der Charalambos Makridakis erfasst mit jedem Aufruf
        ...
        <p className="mb-4">
          ...
          Charalambos Makridakis keine Rückschlüsse auf die betroffene Person.
          ...
          anonym erhobenen Daten und Informationen werden durch die Charalambos
          Makridakis daher einerseits statistisch und ferner mit dem Ziel
        ...
        <ul className="list-disc pl-6 mb-4 space-y-4">
          <li>
            <h3 className="text-lg font-medium">a) Recht auf Bestätigung</h3>
            <p>
          ...
          <li>
            <h3 className="text-lg font-medium">b) Recht auf Auskunft</h3>
            <p>
          ...
          <li>
            <h3 className="text-lg font-medium">c) Recht auf Berichtigung</h3>
            <p>
              Jede von der Verarbeitung personenbezogener Daten betroffene
              Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
          ...
          <li>
            ...
            <p className="mt-2">
              ...
              bei der Charalambos Makridakis gespeichert sind, veranlassen
              ...
              Charalambos Makridakis wird veranlassen, dass dem Löschverlangen
              unverzüglich nachgekommen wird.
            </p>
            <p className="mt-2">
              Wurden die personenbezogenen Daten von der Charalambos Makridakis
              öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
              gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
              Daten verpflichtet, so trifft die Charalambos Makridakis unter
              ...
              der Charalambos Makridakis wird im Einzelfall das Notwendige
              veranlassen.
            </p>
          </li>
          <li>
            ...
            <p className="mt-2">
              ...
              Daten, die bei der Charalambos Makridakis gespeichert sind,
              verlangen möchte, kann sie sich hierzu jederzeit an einen
              Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
              Mitarbeiter der Charalambos Makridakis wird die Einschränkung der
          ...
          <li>
            ...
            <p className="mt-2">
              ...
              Charalambos Makridakis wenden.
            </p>
          </li>
          <li>
            <h3 className="text-lg font-medium">g) Recht auf Widerspruch</h3>
            <p>
              Jede von der Verarbeitung personenbezogener Daten betroffene
              Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
            ...
            <p className="mt-2">
              Die Charalambos Makridakis verarbeitet die personenbezogenen Daten
            ...
            <p className="mt-2">
              Verarbeitet die Charalambos Makridakis personenbezogene Daten, um
              ...
              Person gegenüber der Charalambos Makridakis der Verarbeitung für
              Zwecke der Direktwerbung, so wird die Charalambos Makridakis die
            ...
            <p className="mt-2">
              ...
              Verarbeitung personenbezogener Daten, die bei der Charalambos
              Makridakis zu wissenschaftlichen oder historischen
            ...
            <p className="mt-2">
              ...
              Person direkt an jeden Mitarbeiter der Charalambos Makridakis oder
          ...
          <li>
            ...
            <p className="mt-2">
              ...
              Charalambos Makridakis angemessene Maßnahmen, um die Rechte und
        ...
        <p className="text-sm text-gray-300 mt-8">
          Entwickelt von den LegalTech Spezialisten von Willing & Able, die auch
          das System zur Abbildung der gesetzlich vorgesehenen online Schulungen
          entwickelt haben. Die Texte des Datenschutzerklärungs-Generators
          wurden von Prof. Dr. h.c. Heiko Jonny Maniero und Rechtsanwalt
          Christian Solmecke erstellt und publiziert.
        </p>
      </div>
    </div>
  );
